...
#define FFMPEG_CONFIGURATION "--enable-nonfree --enable-gpl --enable-shared --enable-static --enable-libx264 --enable-libfaac --enable-libmp3lame --enable-libvorbis --enable-libfreetype --enable-libfontconfig --enable-libfribidi"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "gcc 4.9.2 (Ubuntu 4.9.2-0ubuntu1~14.04)"
