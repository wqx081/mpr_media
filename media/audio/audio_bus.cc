#include "media/audio/audio_bus.h"
...
void AudioBus::FromInterleavedPartial(const void* source, int start_frame,
  ...
  switch (bytes_per_sample) {
    case 1:
      FromInterleavedInternal<uint8_t, int16_t>(source, start_frame, frames, this);
      break;
    case 2:
      FromInterleavedInternal<int16_t, int32_t>(source, start_frame, frames, this);
      break;
    case 4:
      FromInterleavedInternal<int32_t, int64_t>(source, start_frame, frames, this);
      break;
    default:
...
void AudioBus::ToInterleavedPartial(int start_frame, int frames,
  ...
  switch (bytes_per_sample) {
    case 1:
      ToInterleavedInternal<uint8_t, int16_t>(this, start_frame, frames, dest);
      break;
    case 2:
      ToInterleavedInternal<int16_t, int32_t>(this, start_frame, frames, dest);
      break;
    case 4:
      ToInterleavedInternal<int32_t, int64_t>(this, start_frame, frames, dest);
      break;
    default:
      DCHECK(false) << "Unsupported bytes per sample encountered.";
